...
def sophie(event, say, ack, client,shortcut, body):
    ack()
    client.chat_postMessage(channel=shortcut['user']['id'], text=f"Xin chào <@{body['user']['id']}>, Tôi là Sophie - HR Chatbot. Bạn có câu hỏi nào cho Sophie - Hãy bấm vào mục liên quan bên dưới nhé!")
